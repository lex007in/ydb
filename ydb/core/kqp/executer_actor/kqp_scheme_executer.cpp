...
public:
    ...
    void Handle(NSchemeShard::TEvForcedCompaction::TEvGetResponse::TPtr& ev) {
        ...
        // const Ydb::Table::IndexBuildState::State state = compaction.GetState();
        // const Ydb::StatusIds::StatusCode compactionStatus = state == Ydb::Table::IndexBuildState::STATE_DONE ? Ydb::StatusIds::SUCCESS : Ydb::StatusIds::PRECONDITION_FAILED;
        return ReplyErrorAndDie(Ydb::StatusIds::SUCCESS, "");
    }
