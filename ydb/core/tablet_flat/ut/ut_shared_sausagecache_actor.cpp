...
Y_UNIT_TEST_SUITE(TSharedPageCache_Actor) {
    ...
    Y_UNIT_TEST(InMemory_Basics) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->PendingRequests->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(1)->Val(), 0);
        ...
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->LoadInFlyPages->Val(), 2);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(1)->Val(), 2);
        ...
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->PendingRequests->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePages->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(1)->Val(), 4);
    ...
    Y_UNIT_TEST(InMemory_Preemption) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(0)->Val(), 1);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(1)->Val(), 0);
        ...
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(1)->Val(), 3);
    }
    ...
    Y_UNIT_TEST(InMemory_Disabling) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->CacheMissPages->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePages->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(0)->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->ActivePagesTier(1)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(sharedCache.Counters->PassivePages->Val(), 0);
    }
